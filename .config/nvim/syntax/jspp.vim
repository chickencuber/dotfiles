...
if (v:version > 704 || v:version == 704 && has('patch1142')) && main_syntax == 'jspp'
...
syntax match jsppMacroUse /\v\w+!/
syntax match jsppMacro /macro!/
syntax match jsppMacro /alias!/
...
"macro
highlight default link jsppMacroUse Type 
