...
Scope {
    ...
    FileView {
        ...
        path: Quickshell.env("HOME")
            + "/.local/state/quickshell/rice/recent-apps.json"
    ...
    function launchSelected(): void {
        if (
            root.selectedIndex < 0 ||
            root.selectedIndex >= filteredApps.values.length
        )
            return
                ...
                ListView {
                    ...
                    delegate: Rectangle {
                        ...
                        RowLayout {
                            ...
                            Rectangle {
                                visible:
                                    root.recentApps.includes(
                                        delegateRoot.modelData.id
                                    )
